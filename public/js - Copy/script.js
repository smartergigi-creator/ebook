...
function initFlipbook() {
    ...
    isMobile
        ...
        // bindToolbarNav(flipbook);

}
// function bindToolbarNav(flipbook) {
...
/* =====================================
   DESKTOP OPEN / CLOSE BOOK (UPDATED)
===================================== */
function attachDesktopEvents(flipbook) {
    ...
    flipbook.on("turning", function (e, page) {
        ...
        /* 🔒 CLOSE BOOK ON COVER OR LAST PAGE */
